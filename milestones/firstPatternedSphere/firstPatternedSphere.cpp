...
int main() {
    ...
    world.addObject(TSphere(TranslationMat(-1.5, 1, -1.0)*ScalingMat(1, 1, 1)), basicMaterial(0.0, 0.0, 0.8, 100, Colour(0, 0.5, 0.8), 1.33, 0, 0.95));
    PhongShader shader;
    std::cout << "Setup complete" << std::endl;
    cam.render(world, shader, 50);
    std::cout << "Image created" << std::endl;
    cam.save("/home/william/CPP/Projects/RayTracer2/milestones/firstPatternedSphere/firstPatternedSphere.ppm");
}
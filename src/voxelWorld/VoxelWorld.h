...
class VoxelWorld {
    ...
    bool intersectTopLevel(unsigned char* stack, const Ray& ray, float& v0x, float& v0y, float& v0z) const;
    bool getNextNeighbour(unsigned char* stack, const Ray& ray, float& v0x, float& v0y, float& v0z, int scale) const;
